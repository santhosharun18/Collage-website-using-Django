...
SECRET_KEY = 'django-insecure-*37!r*_^7+!-(^2_mg#jrqp4@1+3)h4x)zuorxpt6lz0g59bzq'
...
# college_site/settings.py

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': 'collage_web',  # Replace with your MySQL database name
